        ...
        <div className="bg-status-danger/10 border-b border-status-danger/30 p-4 animate-in slide-in-from-top duration-300">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-surface/50 rounded p-3 border border-status-danger/20">
              ...
              <p className="text-xs text-text-secondary">High value Gold tier customer. High churn risk due to repeated billing issues.</p>
            </div>
            <div className="bg-surface/50 rounded p-3 border border-status-danger/20">
              <h4 className="text-[10px] font-bold text-status-danger uppercase mb-1">Issue Summary</h4>
              <p className="text-xs text-text-secondary">Customer claims they were double charged for order #9021 ($348.00 x2).</p>
            </div>
            <div className="bg-surface/50 rounded p-3 border border-status-danger/20">
              <h4 className="text-[10px] font-bold text-status-danger uppercase mb-1">What AI Tried</h4>
              <p className="text-xs text-text-secondary">Checked ledger, saw single charge. Customer provided bank screenshot (escalated).</p>
            </div>
            <div className="bg-surface/50 rounded p-3 border border-status-danger/20">
              <h4 className="text-[10px] font-bold text-status-danger uppercase mb-1">Recommended Approach</h4>
              <p className="text-xs text-text-secondary">Verify with Stripe dashboard. Immediate refund of duplicate charge + courtesy credit.</p>
            </div>
          </div>
        </div>
